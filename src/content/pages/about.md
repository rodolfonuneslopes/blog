...
## Tech Stack
This blog was created with [Astro](https://astro.build/), a JavaScript framework for building content-driven websites such as this blog. Alongside, I've used a couple of other accessory technologies:
...
## Appearence
I used [AstroPaper](https://github.com/satnaing/astro-paper) by [Sat Naing](https://github.com/satnaing), which I then rebranded to my own taste and needs. 
## Main features
- Full-text search
...
## Resources
- [git repo with all the blog code and posts](https://github.com/rodolfonuneslopes/blog)